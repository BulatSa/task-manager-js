...
const renderComponent = (container, componentHTML, where = "beforeend") => {
  const domContainer = document.querySelector(container);
  domContainer.insertAdjacentHTML(where, componentHTML);
};

renderComponent(".main__control", Object(_components_menu__WEBPACK_IMPORTED_MODULE_0__["getMenu"])());
renderComponent(".main", getFilter());
renderComponent(".main", getBoard());
renderComponent(".board", getSort());
renderComponent('.board', getBoardTasks());
renderComponent('.board__tasks', getCart());
renderComponent('.board__tasks', getCart());
renderComponent('.board__tasks', getCart());
renderComponent('.board', getLoadMore());
